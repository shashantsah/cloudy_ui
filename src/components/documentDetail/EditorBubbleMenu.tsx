  ...
  return (
    ...
    >
      ...
      >
        ...
        <Button
          onClick={() => editor.chain().focus().toggleUnderlineHighlight().run()}
          variant="ghost"
          size="icon-sm"
          className={editor.isActive("underlineHighlight") ? "bg-accent/20 text-accent" : ""}
        >
          <UnderlineIcon className="h-4 w-4" />
        </Button>
        ...
        {/* <Button
          ...
          variant="ghost"
          size="icon-sm"
          className={editor.isActive("highlight") ? "bg-accent/20 text-accent" : ""}
        >
