// import { FlattenedItem } from "@/utils/common_utils/";
import {
	DndContext,
	DragOverlay,
	Over,
					...
					<div className="flex w-full flex-col gap-1">
						<div className="flex flex-row items-center justify-between gap-1">
							<CategoryHeader title="Library">
                                    ...
                                    {/* <HelpTooltip
									content={`Drag files and folders around to build this workspace's library. This is where you can structure your knowledgebase.`}
								/> */}
